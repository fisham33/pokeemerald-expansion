...
// Other battle flags
#define B_FLAG_INVERSE_BATTLE       FLAG_ENABLE_INVERSE_BATTLE     // If this flag is set, the battle's type effectiveness are inversed. For example, fire is super effective against water.
#define B_FLAG_FORCE_DOUBLE_WILD    0     // If this flag is set, all land and surfing wild battles will be double battles.
#define B_SMART_WILD_AI_FLAG        FLAG_SMART_WILD_POKEMON     // If this flag is set, wild Pokémon will become smart, with all AI flags enabled.
...
#define B_VAR_STARTING_STATUS       VAR_STARTING_STATUS_CONTROL     // If this var has a value, assigning a STATUS_FIELD_xx_TERRAIN or B_WEATHER_xx to it before battle causes the battle to start with that status active.
