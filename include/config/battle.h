...
#define B_VAR_STARTING_STATUS       VAR_TEMP_E     // If this var has a value, assigning a STATUS_FIELD_xx_TERRAIN or B_WEATHER_xx to it before battle causes the battle to start with that status active.
                                          // This var should never remain non-zero long enough for the player to save.
#define B_VAR_STARTING_STATUS_TIMER VAR_TEMP_F     // If this var has a value greater or equal than 1 field terrains will last that number of turns, otherwise they will last until they're overwritten.
